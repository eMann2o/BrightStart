...
try {
    ...
    // Step 1: Get the district of the logged-in user
    $stmt1 = $db->prepare("SELECT district FROM users WHERE email = :email");
    ...
    // At this point, $rows contains all users in the same district as the logged-in user
